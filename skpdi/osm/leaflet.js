/**
 * Created by asavichev on 28.03.2018.
 */
...
!function (t, i) {
    "object" == typeof exports && "undefined" != typeof
        ...
        define && define.amd ? define(["exports"], i) : i(t.L = {})
}(this, function (t) {
        "use strict";
        function i(t) {
            var i, e, n, o;
        ...
        var me, fe, ge = (Object.freeze || Object)({
            ...
            getBoundsZoom: function (t, i, e) {
                t = z(t), e = w(e || [0, 0]);
                var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), a = t.getSouthEast(), h = this.getSize().subtract(e), u = b(this.project(a, n), this.project(r, n)).getSize(), l = Oi ? this.options.zoomSnap : 1, c = h.x / u.x, _ = h.y / u.y, d = i ? Math.max(c, _) : Math.min(c, _);
        ...
        ye.addInitHook("addHandler", "scrollWheelZoom", Pn), ye.mergeOptions({tap: !0, tapTolerance: 15});
        var bn = Me.extend({
            addHooks: function () {
        ...
        Hi && !Wi && ye.addInitHook("addHandler", "tap", bn), ye.mergeOptions({
            touchZoom: Hi && !Ti,
