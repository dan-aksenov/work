...
%plink_cmd% "sudo rm %app_name%/webapps/portal.war -f"
%plink_cmd% "sudo rm %app_name%/webapps/pts.war -f"
%plink_cmd% "sudo rm %app_name%/webapps/portal2.war"
...
%plink_cmd% "sudo rm %app_name%/webapps/portal2 -rf"
...
md5sum portal2.war
%plink_cmd% "sudo md5sum %app_name%/webapps/portal2.war"
